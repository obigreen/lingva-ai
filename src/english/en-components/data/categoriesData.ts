export const categoriesData = {
    arrAdjectives: [
        ...
        {eng: 'open', rus: 'открытый, раскрытый'},
        {eng: 'extra', rus: 'дополнительный'},
        {eng: 'lazy', rus: 'ленивый'},
        {eng: 'careful', rus: 'внимательный'},
        {eng: 'helpful', rus: 'полезный (информация)'},
        {eng: 'healthy', rus: 'полезный (здоровье)'},
        ...
        {eng: 'difficult', rus: 'сложный, трудный'},
    ...
    arrNouns: [
        ...
        {eng: 'horror', rus: 'ужас'},
        {eng: 'witch', rus: 'ведьма'},
        {eng: 'customer', rus: 'клиент, покупатель'},
        {eng: 'frequency', rus: 'частота (действия)'},
        {eng: 'half', rus: 'половина'},
        {eng: 'quarter', rus: 'четверть'},
        {eng: 'end', rus: 'конец'},
        {eng: 'hurry', rus: 'спешка'},
        {eng: 'worry', rus: 'волнение'},
        {eng: 'course', rus: 'курс, направление'},
        {eng: 'accidents', rus: 'несчастные случаи, аварии'},
        {eng: 'flow', rus: 'поток'},
        {eng: 'liar', rus: 'лжец, врун'},
        {eng: 'truth', rus: 'истина, правда'},
        {eng: 'per cent', rus: 'проценты'},
    ...
    arrPhrases: [
        ...
        {eng: 'It takes me', rus: 'Мне требуется'},
        {eng: 'more or less', rus: 'более или менее, примерно'},
        {eng: 'it depends on', rus: 'это зависит от, по разному'},
        {eng: 'It depends on what you mean', rus: 'это по-разному, смотря что ты имеешь в виду'},
    ...
    arrVerbs: [
        ...
        {eng: 'see', rus: 'видеть'},
        {eng: 'to set', rus: 'устанавливать'},
        {eng: 'test (verb)', rus: 'тестировать'},
        {eng: 'spell', rus: 'произносить (по буквам)'},
        {eng: 'find', rus: 'найти'},
        {eng: 'meet', rus: 'встречаться, знакомиться'},
        {eng: 'repair', rus: 'чинить (формально, глобально)'},
        {eng: 'fix', rus: 'чинить (разговорный, простой)'},
        ...
        {eng: 'dream', rus: 'видеть сон, мечтать'},
        {eng: 'sleep', rus: 'спать'},
        ...
        {eng: 'take place', rus: 'происходить, случаться'},
        {eng: 'flow', rus: 'течь'},
